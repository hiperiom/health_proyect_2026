...
it('updates a Medical History through the form', function () {
    $response = actingAs($this->user)
        ->patch(route('medical-histories.update', $this->item), [
            'name' => 'Updated name',
...
it('redirects guests to login on update', function () {
    patch(route('medical-histories.update', $this->item), ['name' => 'Guest attempt'])
