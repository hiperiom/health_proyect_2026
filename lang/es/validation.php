...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes de validación traducidos al español. Se utilizan los mismos
    | placeholders (:attribute, :value, :min, :max, etc.) que en
    | lang/en/validation.php para mantener la compatibilidad con Laravel.
    |
    */
